...
public class GetAccountInfoSpecificMapper implements RowMapper {
    public GetAccountInfoOutputDTO mapRow(ResultSet rs, int rowNo) throws SQLException{

        GetAccountInfoOutputDTO getAccountInfoOutputDTO =  new GetAccountInfoOutputDTO();
        ...
        getAccountInfoOutputDTO.setBankCredDetailsVO(bankCredDetailsVO);
        getAccountInfoOutputDTO.setUserDemographicInfoVO(userDemographicInfoVO);
        getAccountInfoOutputDTO.setUserOfficialInfoVO(userOfficialInfoVO);
        getAccountInfoOutputDTO.setUserAddressInfoVO(userAddressInfoVO);
        getAccountInfoOutputDTO.setUserProfessionalInfoVO(userProfessionalInfoVO);
